    ...
    <div class="modal-content">
        ...
        <div id="ticketForm" class="request-form" style="display:none;">
            ...
            <form id="ticketFormContent" method="POST">
                ...
                <div class="modal-buttons">
                    <button type="submit" name="subtmitTicketBtn" id="submitTicketID" class="btnDefault">SUBMIT TICKET</button>
        ...
        <div id="leaveForm" class="request-form" style="display:none;">
            ...
            <form id="leaveFormContent" method="POST">
                ...
                <div class="modal-buttons">
                    <button type="submit" id="submitLeaveBtn" name="submitLeaveBtn" class="btnDefault">SUBMIT REQUEST</button>
                    <button type="button" class="btnDanger" onclick="closeModal()">CANCEL</button>
                </div>
            </form>
        </div>
...
<script>
    ...
    function toggleFormType() {
        const formType = document.getElementById('requestType'); // Corrected id from 'formType' to 'requestType'

        if (!formType) {
            console.error("Element with id 'requestType' not found.");
            return;
        }
