document.addEventListener("DOMContentLoaded", function () {
    ...
    // Add Account Modal
    document.getElementById("addAccountID").addEventListener("click", function () {
        ...
        fetch("../../0/includes/editAccountQuery.php", {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById("employeeEditName").value = data.data.name || "";
                    document.getElementById("emailEditID").value = data.data.email || "";
                    document.getElementById("roleEditID").value = data.data.role || "";
                    document.getElementById("departmentEditID").value = data.data.department || "";
    ...
    document.getElementById("editAccountForm").addEventListener("submit", function (e) {
        ...
        fetch("../../0/includes/updateAccount.php", { // Update the URL to your PHP script
            method: "POST",
            body: formData,
        })
            .then(response => response.json())
    ...
    disableButton.addEventListener("click", function () {
        ...
        document.getElementById("idDisableHidden").value = selectedRow.getAttribute("data-id");
        document.getElementById("employeeDisableID").value = selectedRow.cells[0].innerText;
        document.getElementById("employeeDisableName").value = selectedRow.cells[1].innerText;
        document.getElementById("emailDisableID").value = selectedRow.cells[2].innerText;
        document.getElementById("employeeDisableRole").value = selectedRow.cells[3].innerText;
        document.getElementById("employeeDisableDepartment").value = selectedRow.cells[4].innerText;
